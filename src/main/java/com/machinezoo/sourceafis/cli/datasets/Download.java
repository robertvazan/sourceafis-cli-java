...
public class Download {
	private static String url(Dataset dataset) {
		return switch (dataset.format()) {
			case ORIGINAL -> switch (dataset.sample()) {
					case FVC2000_1B -> "https.machinezoo.com/h/O_mBtWH-PXJ4ETJJe_G-Z9EmJoJLfq4srVw23tTEMZw/fvc2000-1b.zip";
			...
			case GRAY -> switch (dataset.sample()) {
	...
	public static Path directory(Dataset dataset) {
		var subdirectory = switch (dataset.format()) {
